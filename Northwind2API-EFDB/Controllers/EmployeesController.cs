...
namespace Northwind2API_EFDB.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        */
        ...
        public async Task<ActionResult<Employee>> GetEmployee(int id)
        {
            var employee = await _context.Employee.Include(e => e.EmployeeTerritory).ThenInclude(t=> t.Territory).ThenInclude(r => r.Region).FirstOrDefaultAsync(e => e.EmployeeId == id);
