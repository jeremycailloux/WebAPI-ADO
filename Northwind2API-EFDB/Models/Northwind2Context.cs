...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                DbContextOptionsBuilder dbContextOptionsBuilder = optionsBuilder.UseSqlServer("Server=(localdb)\\mssqllocaldb;Database=Northwind2;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                ...
                entity.Property(e => e.Rowversion)
                    .IsRequired()
                    .IsRowVersion() // 9.4 Propriété Rowversion: Pour gérer les accès concurrentiels, SQL Server fournit le type de donnée rowversion, adapté pour cela. Il s’agit d’un nombre binaire unique incrémenté automatiquement à chaque modification de l’enregistrement.
                    .IsConcurrencyToken();
            ...
            modelBuilder.Entity<Supplier>(entity =>
            {
                ...
                entity.HasOne(d => d.Address)
                    ...
                    .HasForeignKey(d => d.AddressId)
                    .OnDelete(DeleteBehavior.ClientSetNull) //ClientCascade ne fonctionne pas , il faut supprimer l'adreese soit même
